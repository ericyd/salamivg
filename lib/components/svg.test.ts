  ...
  describe('defineLinearGradient', () => {
    it('renders defs', () => {
      ...
      const expected = [
        ...
        '<stop id="123_0" offset="0" stop-color="rgb(0, 0, 0, 1)" style="stop-color:#000000;stop-opacity:1;"></stop>',
        '<stop id="123_1" offset="100" stop-color="rgb(255, 255, 255, 1)" style="stop-color:#ffffff;stop-opacity:1;"></stop>',
        '</linearGradient>',
        '</defs>',
