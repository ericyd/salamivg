...
export class Rectangle extends Tag {
  ...
  constructor({ x = 0, y = 0, width = 1, height = 1, ...attributes } = {}) {
    super(
      'rect',
      // TODO@v1: move this to top-level Tag.render() method; removing undefined values should not be the concern of specific classes
   ...
   */
  get x() {
    // @ts-expect-error attributes is just a Record, x is not guaranteed (but just as nothing in JS is "guaranteed")
